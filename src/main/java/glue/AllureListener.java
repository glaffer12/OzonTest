...
public class AllureListener implements Formatter {
    ...
    private Status translateTestCaseStatus(final Result testCaseResult) {
        switch (testCaseResult.getStatus()) {
            case FAILED:
                lifecycle.addAttachment("Screenshot",(String)null,(String)null,((TakesScreenshot) DriverManager.getDriver()).getScreenshotAs(OutputType.BYTES));
